...
<body>
                            ...
                            <nav class="tgmenu__nav">
                                ...
                                <div class="tgmenu__action tgmenu__action-six">
                                    <ul class="list-wrap">
                                        ...
                                        <li class="header-btn">
                                            <a href="login.html" class="btn arrow-btn">Learn For Free <img src="assets/img/icons/right_arrow.svg" alt="img" class="injectable"></a>
                                        </li>
                                    </ul>
                                </div>
    ...
    <main class="main-area fix">
        ...
        <!-- banner-area -->
        <section class="banner-area banner-bg-six tg-motion-effects" data-background="assets/img/banner/h6_hero_bg.jpg">
            <div class="container">
                    ...
                    <div class="col-lg-7 col-md-9 col-sm-10 order-0 order-lg-2">
                        <div class="banner__images-six">
                            <div class="main-img tg-svg">
                                ...
                                <span class="svg-icon" id="banner-svg" data-svg-icon="assets/img/banner/h6_banner_img_shape03.svg"></span>
                            </div>
                            ...
                            <div class="shape-wrap">
                                ...
                                <img src="assets/img/banner/h6_banner_img_shape02.svg" alt="shape" class="alltuchtopdown">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="banner__content-six">
                            ...
                            <div class="banner__btn-wrap-three" data-aos="fade-up" data-aos-delay="800">
                                <a href="courses.html" class="btn arrow-btn btn-four">Explore All Course <img src="assets/img/icons/right_arrow.svg" alt="img" class="injectable"></a>
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="categories__item-two">
                            <a href="courses.html">
                                <div class="content">
                                    <img src="assets/img/flags/flag_01.svg" alt="img">
                                    <span class="name"><strong>German</strong>2 Courses</span>
                                </div>
                                <div class="icon">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="categories__item-two">
                            <a href="courses.html">
                                <div class="content">
                                    <img src="assets/img/flags/flag_02.svg" alt="img">
                                    <span class="name"><strong>Canada</strong>4 Courses</span>
                                </div>
                                <div class="icon">
                                    <i class="skillgro-next-2"></i>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="categories__item-two">
                            <a href="courses.html">
                                <div class="content">
                                    <img src="assets/img/flags/flag_03.svg" alt="img">
                                    <span class="name"><strong>France</strong>7 Courses</span>
                                </div>
                                <div class="icon">
                                    <i class="skillgro-next-2"></i>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="categories__item-two">
                            <a href="courses.html">
                                <div class="content">
                                    <img src="assets/img/flags/flag_04.svg" alt="img">
                                    <span class="name"><strong>Italy</strong>3 Courses</span>
                                </div>
                                <div class="icon">
                                    <i class="skillgro-next-2"></i>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="categories__item-two">
                            <a href="courses.html">
                                <div class="content">
                                    <img src="assets/img/flags/flag_05.svg" alt="img">
                                    <span class="name"><strong>Japan</strong>5 Courses</span>
                                </div>
                                <div class="icon">
                                    <i class="skillgro-next-2"></i>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="categories__item-two">
                            <a href="courses.html">
                                <div class="content">
                                    <img src="assets/img/flags/flag_06.svg" alt="img">
                                    <span class="name"><strong>Denmark</strong>8 Courses</span>
                                </div>
                                <div class="icon">
                                    <i class="skillgro-next-2"></i>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="categories__item-two">
                            <a href="courses.html">
                                <div class="content">
                                    <img src="assets/img/flags/flag_07.svg" alt="img">
                                    <span class="name"><strong>Ghana</strong>2 Courses</span>
                                </div>
                                <div class="icon">
                                    <i class="skillgro-next-2"></i>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="categories__item-two">
                            <a href="courses.html">
                                <div class="content">
                                    <img src="assets/img/flags/flag_08.svg" alt="img">
                                    <span class="name"><strong>New Zealand</strong>6 Courses</span>
                                </div>
                                <div class="icon">
                                    <i class="skillgro-next-2"></i>
                                </div>
