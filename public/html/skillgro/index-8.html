...
<body>
                    ...
                    <div class="col-12">
                        <div class="tgmenu__wrap">
                            <nav class="tgmenu__nav">
                                ...
                                <div class="tgmenu__action tgmenu__action-five tgmenu__action-eight">
                                    <ul class="list-wrap">
                                        <li class="header-user">
                                            <a href="instructor-dashboard.html"><img src="assets/img/icons/user.svg" alt="" class="injectable"></a>
                                        </li>
    ...
    <main class="main-area fix">
        ...
        <!-- banner-area -->
        <section class="banner-area fix banner-bg-seven tg-motion-effects" data-background="assets/img/banner/h8_hero_bg.jpg">
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6">
                        <div class="banner__content-seven">
                            <h2 class="title">Take Your
                                <span>Cooking <img src="assets/img/banner/h8_hero_title_shape.svg" alt="" class="injectable"></span>
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="brand__item-two">
                                                <img src="assets/img/brand/h8_brand01.png" alt="img">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="brand__item-two">
                                                <img src="assets/img/brand/h8_brand02.png" alt="img">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="brand__item-two">
                                                <img src="assets/img/brand/h8_brand03.png" alt="img">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="brand__item-two">
                                                <img src="assets/img/brand/h8_brand04.png" alt="img">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="brand__item-two">
                                                <img src="assets/img/brand/h8_brand05.png" alt="img">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="brand__item-two">
                    ...
                    <div class="col-lg-6 col-md-10">
                        <div class="banner__images-seven">
                            <img src="assets/img/banner/h8_hero_img.png" alt="img" class="main-img">
                            <div class="big_shape">
                                <img src="assets/img/banner/h8_hero_img_shape02.svg" alt="" class="injectable tg-motion-effects1">
                            </div>
                            <div class="shape" >
                                <img src="assets/img/banner/h8_hero_img_shape.svg" alt="" class="rotateme">
                            </div>
        ...
        <section class="courses-area-seven section-py-140">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                        <div class="section__title text-center mb-30">
                            ...
                            <h2 class="title bold">Most Popular Courses</h2>
                        </div>
                        <div class="courses__nav-two mb-50">
                            <ul class="nav nav-tabs" id="courseTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pizza-tab" data-bs-toggle="tab" data-bs-target="#pizza-tab-pane" type="button"
                                        role="tab" aria-controls="pizza-tab-pane" aria-selected="false">
                                        Pizza
                                    </button>
                                </li>
                            </ul>
                    ...
                    <div class="tab-pane fade show active" id="all-tab-pane" role="tabpanel" aria-labelledby="all-tab" tabindex="0">
                        <div class="row justify-content-center">
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="courses__item-nine shine__animate-item">
                                    <div class="courses__item-thumb-eight shine__animate-link">
                                        <a href="course-details.html"><img src="assets/img/courses/h8_course_thumb01.jpg" alt="img"></a>
                                        <a href="course-details.html" class="courses__wishlist"><img src="assets/img/icons/heart02.svg" alt="" class="injectable"></a>
                                        <a href="courses.html" class="courses__item-tag-three">Chinese</a>
                                    </div>
                                    <div class="courses__item-content-eight">
                                        ...
                                        <h2 class="title"><a href="course-details.html">It Statistics Data Science
                                        And Business Analysis</a></h2>
                                    ...
                                    <div class="courses__item-bottom-three courses__item-bottom-six">
                                        <ul class="list-wrap">
                                            ...
                                            <li><i class="flaticon-clock"></i>34 mins</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="courses__item-nine shine__animate-item">
                                    <div class="courses__item-thumb-eight shine__animate-link">
                                        <a href="course-details.html"><img src="assets/img/courses/h8_course_thumb02.jpg" alt="img"></a>
                                        <a href="course-details.html" class="courses__wishlist"><img src="assets/img/icons/heart02.svg" alt="" class="injectable"></a>
                                        <a href="courses.html" class="courses__item-tag-three">Dessert</a>
                                    </div>
                                    <div class="courses__item-content-eight">
                                        <div class="courses__review">
                                            <div class="rating">
                                    ...
                                    <div class="courses__item-bottom-three courses__item-bottom-six">
                                        <ul class="list-wrap">
                                            <li><i class="flaticon-book"></i>Lessons 05</li>
                                            <li><i class="flaticon-clock"></i>20 mins</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="courses__item-nine shine__animate-item">
                                    <div class="courses__item-thumb-eight shine__animate-link">
                                        <a href="course-details.html"><img src="assets/img/courses/h8_course_thumb03.jpg" alt="img"></a>
                                        <a href="course-details.html" class="courses__wishlist"><img src="assets/img/icons/heart02.svg" alt="" class="injectable"></a>
                                        <a href="courses.html" class="courses__item-tag-three">Pizza</a>
                                    </div>
                                    <div class="courses__item-content-eight">
                                        <div class="courses__review">
                                            <div class="rating">
                                    ...
                                    <div class="courses__item-bottom-three courses__item-bottom-six">
                                        <ul class="list-wrap">
                                            <li><i class="flaticon-book"></i>Lessons 05</li>
                                            <li><i class="flaticon-clock"></i>30 mins</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="courses__item-nine shine__animate-item">
                                    <div class="courses__item-thumb-eight shine__animate-link">
                                        <a href="course-details.html"><img src="assets/img/courses/h8_course_thumb04.jpg" alt="img"></a>
                                        <a href="course-details.html" class="courses__wishlist"><img src="assets/img/icons/heart02.svg" alt="" class="injectable"></a>
                                        <a href="courses.html" class="courses__item-tag-three">Italian</a>
                                    </div>
                                    <div class="courses__item-content-eight">
                                        <div class="courses__review">
                                            <div class="rating">
                                        ...
                                        <h2 class="title"><a href="course-details.html">It Statistics Data Science
                                        And Business Analysis</a></h2>
                                        <h2 class="price">$79.00</h2>
                                    </div>
                                    <div class="courses__item-bottom-three courses__item-bottom-six">
                                        <ul class="list-wrap">
                                            <li><i class="flaticon-book"></i>Lessons 05</li>
                                            <li><i class="flaticon-clock"></i>304 mins</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="courses__item-nine shine__animate-item">
                                    <div class="courses__item-thumb-eight shine__animate-link">
                                        <a href="course-details.html"><img src="assets/img/courses/h8_course_thumb05.jpg" alt="img"></a>
                                        <a href="course-details.html" class="courses__wishlist"><img src="assets/img/icons/heart02.svg" alt="" class="injectable"></a>
                                        <a href="courses.html" class="courses__item-tag-three">Pizza</a>
                                    </div>
                                    <div class="courses__item-content-eight">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="courses__item-nine shine__animate-item">
                                    <div class="courses__item-thumb-eight shine__animate-link">
                                        <a href="course-details.html"><img src="assets/img/courses/h8_course_thumb06.jpg" alt="img"></a>
                                        <a href="course-details.html" class="courses__wishlist"><img src="assets/img/icons/heart02.svg" alt="" class="injectable"></a>
                                        <a href="courses.html" class="courses__item-tag-three">Chinese</a>
                                    </div>
                                    <div class="courses__item-content-eight">
                                    ...
                                    <div class="courses__item-bottom-three courses__item-bottom-six">
                                        <ul class="list-wrap">
                                            <li><i class="flaticon-book"></i>Lessons 05</li>
                                            <li><i class="flaticon-clock"></i>44 mins</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="courses__item-nine shine__animate-item">
                                    <div class="courses__item-thumb-eight shine__animate-link">
                                        <a href="course-details.html"><img src="assets/img/courses/h8_course_thumb07.jpg" alt="img"></a>
                                        <a href="course-details.html" class="courses__wishlist"><img src="assets/img/icons/heart02.svg" alt="" class="injectable"></a>
                                        <a href="courses.html" class="courses__item-tag-three">Dessert</a>
                                    </div>
                                    <div class="courses__item-content-eight">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="courses__item-nine shine__animate-item">
                                    <div class="courses__item-thumb-eight shine__animate-link">
                                        <a href="course-details.html"><img src="assets/img/courses/h8_course_thumb08.jpg" alt="img"></a>
                                        <a href="course-details.html" class="courses__wishlist"><img src="assets/img/icons/heart02.svg" alt="" class="injectable"></a>
                                        <a href="courses.html" class="courses__item-tag-three">Italian</a>
                                    </div>
                                    <div class="courses__item-content-eight">
                                    ...
                                    <div class="courses__item-bottom-three courses__item-bottom-six">
                                        <ul class="list-wrap">
                                            <li><i class="flaticon-book"></i>Lessons 05</li>
                                            <li><i class="flaticon-clock"></i>22 mins</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="discover-courses-btn-two text-center mt-30">
                    <a href="courses.html" class="btn arrow-btn btn-four">Discover All Class <img src="assets/img/icons/right_arrow.svg" alt="" class="injectable"></a>
                </div>
            </div>
            <div class="courses__shape-wrap-four">
                <img src="assets/img/courses/h8_course_shape01.svg" alt="shape" class="alltuchtopdown">
                <img src="assets/img/courses/h8_course_shape02.svg" alt="shape" class="rotateme">
            </div>
        </section>
        <!-- courses-area-end -->

        <!-- about-area -->
        <section class="about-area-six about__bg" data-background="assets/img/bg/h8_about_bg.jpg">
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 col-md-10">
                        <div class="about__images-six">
                            ...
                            <div class="about__success" data-aos="fade-up" data-aos-delay="400">
                                ...
                                <div class="content">
                                    <h2 class="title">86%</h2>
                                    <span>Course Success</span>
                                </div>
                            </div>
                            <div class="shape">
                                <img src="assets/img/others/h8_about_img_shape.svg" alt="shape" class="alltuchtopdown">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about__content-six">
                            <div class="section__title mb-15">
                                ...
                                <h2 class="title">Thousand Of Top
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-10">
                        ...
                        <div class="cta__img-three tg-svg">
                            ...
                            <span class="svg-icon" id="cta-svg" data-svg-icon="assets/img/others/h8_cta_img_shape.svg"></span>
                        </div>
                        ...
                        <img src="assets/img/others/h8_cta_shape.svg" alt="shape" class="shape">
                    </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-8">
                        <div class="section__title text-center mb-50">
                            ...
                            <h2 class="title bold">Our Food categories</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="categories__item-four shine__animate-item">
                            <a href="courses.html" class="shine__animate-link">
                                <img src="assets/img/categories/cat_img01.jpg" alt="img">
                                <span class="name">Chinese <strong>(22)</strong></span>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="categories__item-four shine__animate-item">
                            <a href="courses.html" class="shine__animate-link">
                                <img src="assets/img/categories/cat_img02.jpg" alt="img">
                                <span class="name">Dessert <strong>(15)</strong></span>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="categories__item-four shine__animate-item">
                            <a href="courses.html" class="shine__animate-link">
                                <img src="assets/img/categories/cat_img03.jpg" alt="img">
                                <span class="name">Italian <strong>(30)</strong></span>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="categories__item-four shine__animate-item">
                            <a href="courses.html" class="shine__animate-link">
                                <img src="assets/img/categories/cat_img04.jpg" alt="img">
                                <span class="name">Bread <strong>(20)</strong></span>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="categories__item-four shine__animate-item">
                            <a href="courses.html" class="shine__animate-link">
                                <img src="assets/img/categories/cat_img05.jpg" alt="img">
                                <span class="name">Pizza <strong>(50)</strong></span>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="categories__item-four shine__animate-item">
                            <a href="courses.html" class="shine__animate-link">
                                <img src="assets/img/categories/cat_img06.jpg" alt="img">
                                <span class="name">Salad <strong>(10)</strong></span>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="categories__item-four shine__animate-item">
                            <a href="courses.html" class="shine__animate-link">
                                <img src="assets/img/categories/cat_img07.jpg" alt="img">
                                <span class="name">Italian <strong>(12)</strong></span>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="categories__item-four shine__animate-item">
                            <a href="courses.html" class="shine__animate-link">
                                <img src="assets/img/categories/cat_img08.jpg" alt="img">
                                <span class="name">Chinese <strong>(25)</strong></span>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <!-- categories-area-end -->
         ...
         <!-- testimonial-area -->
        <section class="testimonial__area-six section-py-140 testimonial__bg-three" data-background="assets/img/bg/h8_testimonial_bg.jpg">
            <div class="container">
            ...
            <div class="testimonial__shape-wrap-two">
                ...
                <img src="assets/img/others/h8_testimonial_shape02.svg" alt="shape" data-aos="fade-up-right" data-aos-delay="400">
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6">
                        <div class="blog__post-item-six shine__animate-item">
                            <div class="blog__post-thumb-six">
                                <a href="blog-details.html" class="shine__animate-link"><img src="assets/img/blog/h8_blog_post01.jpg" alt="img"></a>
                            ...
                            <div class="blog__post-content-six">
                                ...
                                <a href="blog-details.html" class="btn arrow-btn">Read More <img src="assets/img/icons/right_arrow.svg" alt="" class="injectable"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="blog__post-item-six shine__animate-item">
                            <div class="blog__post-thumb-six">
                                <a href="blog-details.html" class="shine__animate-link"><img src="assets/img/blog/h8_blog_post02.jpg" alt="img"></a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog__post-item-six shine__animate-item">
                            <div class="blog__post-thumb-six">
                                <a href="blog-details.html" class="shine__animate-link"><img src="assets/img/blog/h8_blog_post03.jpg" alt="img"></a>
        ...
        <section class="newsletter__area-three">
            <div class="container">
                <div class="newsletter__inner-wrap newsletter__inner-wrap-two">
                    <h2 class="title">Start today and get certified in Fundamentals of Business Core</h2>
                    <form action="#" class="newsletter__form-two">
                        <input type="email" placeholder="Enter your e-mial">
                        <button type="submit" class="btn arrow-btn">Subscribe Now</button>
                    </form>
                    <img src="assets/img/others/h7_newsletter_shape01.svg" alt="shape" data-aos="fade-down-right" data-aos-delay="400" class="shape shape-one">
                    <img src="assets/img/others/h7_newsletter_shape02.svg" alt="shape" class="shape shape-two rotateme">
                </div>
            </div>
        </section>
        <!-- newsletter-area-end -->
    ...
    <footer class="footer__area footer__area-five">
        <div class="footer__top footer__top-three">
            ...
            <div class="footer__shape" data-background="assets/img/others/h8_footer_shape.svg"></div>
        </div>
