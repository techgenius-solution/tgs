                                            ...
                                            <ul class="sub-menu">
                                                <li class="active menu-item-has-children">
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="active"><a href="instructor-assignment.html">Assignments</a></li>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="dashboard__quiz-info">
                                                            ...
                                                            <span>Course: <a href="#">Song Writing</a></span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <p class="color-black">80</p>
                                                    </td>
                                                    <td>
