...
document.addEventListener("DOMContentLoaded", function () {
    ...
    navLinks.forEach(link => {
        const linkHref = link.getAttribute("href").replace(/^\/|\/$/g, ""); // normalize
    ...
    // If no active found and we're at root (i.e., home page), make Home active
    if (!activeFound && currentPath === "") {
        const homeLink = document.querySelector('.navigation li a[href="/"], .navigation li a[href="#"]');
        if (homeLink) {
