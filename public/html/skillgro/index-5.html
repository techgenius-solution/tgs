...
<body>
                    ...
                    <div class="col-lg-6">
                        <div class="tg-header__top-right">
                            ...
                            <div class="tg-header__top-btn">
                                <a href="contact.html" class="btn arrow-btn">Get in Touch <img src="assets/img/icons/right_arrow.svg" alt="" class="injectable"></a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <ul class="list-wrap">
                                        <li>
                                            <div class="tgmenu__search tgmenu__search-two  d-none d-md-block">
                                                <form action="#" class="tgmenu__search-form tgmenu__search-form-two">
                                                    <div class="input-grp">
    ...
    <main class="main-area fix">
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-xl-5 col-lg-5">
                        <div class="banner__content-five">
                            <span class="sub-title" data-aos="fade-right" data-aos-delay="200">Kindergarten Care School</span>
                            <h2 class="title" data-aos="fade-right" data-aos-delay="400">Together We’ll Explore <span>New Things</span></h2>
                            ...
                            <div class="banner__btn" data-aos="fade-right" data-aos-delay="800">
                                <a href="courses.html" class="btn arrow-btn">Explore All Course <img src="assets/img/icons/right_arrow.svg" alt="img" class="injectable"></a>
                            </div>
                        </div>
                    </div>
        ...
        <section class="features__area-six section-pt-140 section-pb-110">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-8">
                        <div class="section__title text-center mb-40">
                            <h2 class="title bold">Grow and expand your skills through enjoyable & imaginative</h2>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                            <div class="features__item-five">
                                <div class="features__item-five-shape">
                                    <div class="shape-one">
                                        <img src="assets/img/others/h5_features_item_shape.svg" alt="" class="injectable">
                                    </div>
                                    <div class="shape-two">
                                        <img src="assets/img/others/h5_features_item_shape02.svg" alt="" class="injectable">
                                    </div>
                                </div>
                                <div class="features__icon-five">
                                    <i class="skillgro-video-tutorial"></i>
                                    <img src="assets/img/icons/h5_features_icon.svg" alt="" class="injectable">
                                </div>
                                <div class="features__content-five">
                                    <h2 class="title">Easy Class</h2>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                            <div class="features__item-five">
                                ...
                                <div class="features__content-five">
                                    <h2 class="title">Skilled Teacher</h2>
                                    <p>Dear psum dolor amettey adipis aecing eiusmod incididutt reore</p>
                                    <a href="about-us.html" class="btn arrow-btn">Read More <img src="assets/img/icons/right_arrow.svg" alt="" class="injectable"></a>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                            <div class="features__item-five">
                                ...
                                <div class="features__content-five">
                                    <h2 class="title">Clean Curriculum</h2>
                                    <p>Dear psum dolor amettey adipis aecing eiusmod incididutt reore</p>
                                    <a href="about-us.html" class="btn arrow-btn">Read More <img src="assets/img/icons/right_arrow.svg" alt="" class="injectable"></a>
                                </div>
                            </div>
            ...
            <div class="features__shape-wrap-two">
                <img src="assets/img/others/h5_features_shape01.svg" alt="shape" class="rotateme">
                    ...
                    <div class="col-lg-6">
                        <div class="about__content-five">
                            ...
                            <div class="about__content-bottom">
                                <a href="contact.html" class="btn arrow-btn">Start Free Trial <img src="assets/img/icons/right_arrow.svg" alt="" class="injectable"></a>
        ...
        <!-- courses-area -->
        <section class="courses-area-four courses__bg-three" data-background="assets/img/bg/h5_courses_bg.jpg">
            <div class="courses__bg-shape-one">
                <img src="assets/img/courses/h5_courses_bg_shape01.svg" alt="" class="injectable">
            </div>
            <div class="courses__bg-shape-two">
                <img src="assets/img/courses/h5_courses_bg_shape02.svg" alt="" class="injectable">
            </div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-lg-8">
                        <div class="section__title text-center mb-50">
                            ...
                            <h2 class="title bold">Get The Best Exciting Class Experience With us</h2>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="courses__item-six shine__animate-item">
                            <div class="courses__item-thumb-five shine__animate-link">
                                <a href="course-details.html"><img src="assets/img/courses/h5_course_thumb01.jpg" alt="img"></a>
                            ...
                            <div class="courses__item-content-five">
                                ...
                                <h2 class="title"><a href="course-details.html">Mathematics Class</a></h2>
                                <p>The foundation of the Monte areay ssori philosophy</p>
                                <div class="courses__item-content-bottom-two">
                                    <ul class="list-wrap">
                                        <li>
                                            <div class="icon">
                                                <i class="skillgro-happiness"></i>
                                            </div>
                                            <p><span>Age:</span>1-5 Years</p>
                                        </li>
                                        <li>
                                            <div class="icon">
                                                <i class="skillgro-time"></i>
                                            </div>
                                            <p><span>Time: </span>08 - 10am</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="courses__item-six shine__animate-item">
                            <div class="courses__item-thumb-five shine__animate-link">
                                <a href="course-details.html"><img src="assets/img/courses/h5_course_thumb02.jpg" alt="img"></a>
                                <a href="course-details.html" class="courses__wishlist-two"><img src="assets/img/icons/heart02.svg" alt="" class="injectable"></a>
                            </div>
                            <div class="courses__item-content-five">
                                <ul class="courses__item-meta list-wrap">
                                    ...
                                    <li class="price">$62</li>
                                </ul>
                                <h2 class="title"><a href="course-details.html">Pre-Nursery Class</a></h2>
                                <p>The foundation of the Monte areay ssori philosophy</p>
                                <div class="courses__item-content-bottom-two">
                                    <ul class="list-wrap">
                                        <li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="courses__item-six shine__animate-item">
                            <div class="courses__item-thumb-five shine__animate-link">
                                <a href="course-details.html"><img src="assets/img/courses/h5_course_thumb03.jpg" alt="img"></a>
                                <a href="course-details.html" class="courses__wishlist-two"><img src="assets/img/icons/heart02.svg" alt="" class="injectable"></a>
                            </div>
                            <div class="courses__item-content-five">
                                <ul class="courses__item-meta list-wrap">
                                    ...
                                    <li class="price">$84</li>
                                </ul>
                                <h2 class="title"><a href="course-details.html">Art & Creativity Class</a></h2>
                                <p>The foundation of the Monte areay ssori philosophy</p>
                                <div class="courses__item-content-bottom-two">
                                    <ul class="list-wrap">
                                        <li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="courses__item-six shine__animate-item">
                            <div class="courses__item-thumb-five shine__animate-link">
                                <a href="course-details.html"><img src="assets/img/courses/h5_course_thumb04.jpg" alt="img"></a>
                                <a href="course-details.html" class="courses__wishlist-two"><img src="assets/img/icons/heart02.svg" alt="" class="injectable"></a>
                            </div>
                            <div class="courses__item-content-five">
                                <ul class="courses__item-meta list-wrap">
                                    ...
                                    <li class="price">$32</li>
                                </ul>
                                <h2 class="title"><a href="course-details.html">Drawing Class</a></h2>
                                <p>The foundation of the Monte areay ssori philosophy</p>
                                <div class="courses__item-content-bottom-two">
                                    <ul class="list-wrap">
                                        <li>
            ...
            <div class="courses__shape-wrap-three">
                ...
                <img src="assets/img/courses/h5_courses_shape02.svg" alt="shape" data-aos="fade-up-right" data-aos-delay="400">
                <img src="assets/img/courses/h5_courses_shape03.svg" alt="shape" class="alltuchtopdown">
                <img src="assets/img/courses/h5_courses_shape04.svg" alt="shape" data-aos="fade-up-left" data-aos-delay="400">
            </div>
        </section>
        <!-- courses-area-end -->
        ...
        <section class="instructor__area-six section-pb-110">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-lg-7">
                        <div class="section__title text-center mb-50">
                            <span class="sub-title">Our Teacher</span>
                            <h2 class="title">Meet our expert & smart Instructors</h2>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="instructor__item-five">
                            <div class="instructor__thumb-five">
                                <a href="instructor-details.html"><img src="assets/img/instructor/h5_instructor01.jpg" alt="img"></a>
                            ...
                            <div class="instructor__content-five">
                                <h2 class="title"><a href="instructor-details.html">Wade Warren</a></h2>
                                <span>Sports Teacher</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="instructor__item-five">
                            <div class="instructor__thumb-five">
                                <a href="instructor-details.html"><img src="assets/img/instructor/h5_instructor02.jpg" alt="img"></a>
                                <div class="instructor__social-two">
                                    <ul class="list-wrap">
                                        <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                            ...
                            <div class="instructor__content-five">
                                <h2 class="title"><a href="instructor-details.html">Cody Fisher</a></h2>
                                <span>Sports Teacher</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="instructor__item-five">
                            <div class="instructor__thumb-five">
                                <a href="instructor-details.html"><img src="assets/img/instructor/h5_instructor03.jpg" alt="img"></a>
                                <div class="instructor__social-two">
                                    <ul class="list-wrap">
                                        <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                            ...
                            <div class="instructor__content-five">
                                <h2 class="title"><a href="instructor-details.html">Dianne Russell</a></h2>
                                <span>Sports Teacher</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="instructor__item-five">
                            <div class="instructor__thumb-five">
                                <a href="instructor-details.html"><img src="assets/img/instructor/h5_instructor04.jpg" alt="img"></a>
                                <div class="instructor__social-two">
                                    <ul class="list-wrap">
                                        <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                            ...
                            <div class="instructor__content-five">
                                <h2 class="title"><a href="instructor-details.html">Jerome Bell</a></h2>
                                <span>Sports Teacher</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="instructor__shape-two">
                <img src="assets/img/instructor/h5_instructor_img_shape01.svg" alt="shape" class="rotateme">
                <img src="assets/img/instructor/h5_instructor_img_shape02.svg" alt="shape" class="alltuchtopdown">
            </div>
        </section>
        <!-- instructor-area-end -->
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6">
                        <div class="blog__post-item-four shine__animate-item">
                            <div class="blog__post-thumb-four">
                                <a href="blog-details.html" class="shine__animate-link"><img src="assets/img/blog/h5_blog_post01.jpg" alt="img"></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog__post-item-four shine__animate-item">
                            <div class="blog__post-thumb-four">
                                <a href="blog-details.html" class="shine__animate-link"><img src="assets/img/blog/h5_blog_post02.jpg" alt="img"></a>
                            </div>
                            <div class="blog__post-content-four">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog__post-item-four shine__animate-item">
                            <div class="blog__post-thumb-four">
                                <a href="blog-details.html" class="shine__animate-link"><img src="assets/img/blog/h5_blog_post03.jpg" alt="img"></a>
                            </div>
                            <div class="blog__post-content-four">
    ...
    <!-- footer-area -->
    <footer class="footer__area-four footer__bg" data-background="assets/img/bg/h5_footer.jpg">
        <div class="footer__bg-shape">
            <img src="assets/img/others/h5_footer_bg_shape.svg" alt="" class="injectable">
        </div>
        ...
        <div class="footer__shape-wrap">
            ...
            <div class="shape-inner">
                <img src="assets/img/others/h5_footer_shape05.svg" alt="shape" class="injectable">
            </div>
        </div>
    </footer>
    <!-- footer-area-end -->
