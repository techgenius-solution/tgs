                                            ...
                                            <ul class="sub-menu">
                                                <li class="active menu-item-has-children">
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="active"><a href="instructor-review.html">Reviews</a></li>
                                    ...
                                    <div class="dashboard__nav-wrap">
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active" id="itemOne-tab" data-bs-toggle="tab" data-bs-target="#itemOne-tab-pane" type="button" role="tab" aria-controls="itemOne-tab-pane" aria-selected="true">Received</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="itemTwo-tab" data-bs-toggle="tab" data-bs-target="#itemTwo-tab-pane" type="button" role="tab" aria-controls="itemTwo-tab-pane" aria-selected="false">Given</button>
                                            </li>
                                        </ul>
                                    </div>
                                                ...
                                                <table class="table table-borderless">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span class="course-feedback">
                                                                    Course:
                                                                    <a href="course-details.html">The Complete Graphic Design</a>
                                                                </span>
                                            ...
                                            <div class="dashboard__review-table">
                                                <table class="table table-borderless">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <a href="course-details.html">The Complete Graphic Design for Beginners</a>
                                                            </td>
                                                            <td>
                                                                <div class="review__wrap">
                                                                    <div class="rating">
