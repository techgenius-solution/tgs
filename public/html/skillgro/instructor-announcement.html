                                            ...
                                            <ul class="sub-menu">
                                                <li class="active menu-item-has-children">
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="active"><a href="instructor-announcement.html">Announcements</a></li>
                                    ...
                                    <div class="dashboard__review-table">
                                        <table class="table table-borderless">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <p class="color-black">March 16, 2024</p>
                                                        <p>10.00am</p>
                                                    </td>
                                                    <td>
                                                        <p class="color-black">Announcement Title</p>
                                                ...
                                                <tr>
                                                    <td>
                                                        <p class="color-black">Jan 16, 2024</p>
                                                        <p>11.00am</p>
                                                    </td>
                                                    <td>
                                                        <p class="color-black">Announcement Title</p>
