                            ...
                            <nav class="tgmenu__nav">
                                ...
                                <div class="tgmenu__action tgmenu__action-seven">
                                    <ul class="list-wrap">
                                        ...
                                        <li class="header-btn">
                                            <a href="login.html" class="btn">Try For Free</a>
                                        </li>
                                    </ul>
                                </div>
    ...
    <main class="main-area fix">
            ...
            <div class="swiper-container slider__active">
                <div class="swiper-wrapper">
                    <div class="swiper-slide slider__single">
                        <div class="slider__bg" data-background="assets/img/slider/slider_bg01.webp">
                            <div class="container">
                                <div class="row">
                                    <div class="col-xl-6 col-lg-7">
                                        <div class="slider__content">
                                            ...
                                            <h2 class="title">Find Business
                                                <span>Courses <img src="assets/img/slider/slider_title-shape.svg" alt="" class="injectable"></span>
                                                & Develop Your Skills
                                            </h2>
                    ...
                    <div class="swiper-slide slider__single">
                        <div class="slider__bg" data-background="assets/img/slider/slider_bg02.webp">
                            <div class="container">
                                <div class="row">
                                    <div class="col-xl-6 col-lg-7">
                                        <div class="slider__content">
                    ...
                    <div class="swiper-slide slider__single">
                        <div class="slider__bg" data-background="assets/img/slider/slider_bg03.webp">
                            <div class="container">
                                <div class="row">
                                    <div class="col-xl-6 col-lg-7">
                                        <div class="slider__content">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="courses__item-eight shine__animate-item">
                            <div class="courses__item-thumb-seven shine__animate-link">
                                <a href="course-details.html"><img src="assets/img/courses/h7_course_thumb01.jpg" alt="img"></a>
                                <a href="courses.html" class="courses__item-tag-three">Finance</a>
                            </div>
                            <div class="courses__item-content-seven">
                                ...
                                <h2 class="title"><a href="course-details.html">It Statistics Data Science And Business Analysis</a></h2>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="courses__item-eight shine__animate-item">
                            <div class="courses__item-thumb-seven shine__animate-link">
                                <a href="course-details.html"><img src="assets/img/courses/h7_course_thumb02.jpg" alt="img"></a>
                                <a href="courses.html" class="courses__item-tag-three">Law</a>
                            </div>
                            <div class="courses__item-content-seven">
                                <ul class="courses__item-meta list-wrap">
                                    <li class="price">
                            ...
                            <div class="courses__item-bottom-three courses__item-bottom-five">
                                <ul class="list-wrap">
                                    <li><i class="flaticon-book"></i>Lessons 12</li>
                                    <li><i class="skillgro-group"></i>Students 200</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="courses__item-eight shine__animate-item">
                            <div class="courses__item-thumb-seven shine__animate-link">
                                <a href="course-details.html"><img src="assets/img/courses/h7_course_thumb03.jpg" alt="img"></a>
                                <a href="courses.html" class="courses__item-tag-three">Tax</a>
                            </div>
                            <div class="courses__item-content-seven">
                                <ul class="courses__item-meta list-wrap">
                                    <li class="price">
                            ...
                            <div class="courses__item-bottom-three courses__item-bottom-five">
                                <ul class="list-wrap">
                                    <li><i class="flaticon-book"></i>Lessons 05</li>
                                    <li><i class="skillgro-group"></i>Students 102</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="courses__item-eight shine__animate-item">
                            <div class="courses__item-thumb-seven shine__animate-link">
                                <a href="course-details.html"><img src="assets/img/courses/h7_course_thumb04.jpg" alt="img"></a>
                                <a href="courses.html" class="courses__item-tag-three">Investment</a>
                            </div>
                            <div class="courses__item-content-seven">
                                <ul class="courses__item-meta list-wrap">
                                    <li class="price">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="courses__item-eight shine__animate-item">
                            <div class="courses__item-thumb-seven shine__animate-link">
                                <a href="course-details.html"><img src="assets/img/courses/h7_course_thumb05.jpg" alt="img"></a>
                                <a href="courses.html" class="courses__item-tag-three">HR Professional</a>
                            </div>
                            <div class="courses__item-content-seven">
                                <ul class="courses__item-meta list-wrap">
                                    <li class="price">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="courses__item-eight shine__animate-item">
                            <div class="courses__item-thumb-seven shine__animate-link">
                                <a href="course-details.html"><img src="assets/img/courses/h7_course_thumb06.jpg" alt="img"></a>
                                <a href="courses.html" class="courses__item-tag-three">Tax</a>
                            </div>
                            <div class="courses__item-content-seven">
                                <ul class="courses__item-meta list-wrap">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="courses__item-eight shine__animate-item">
                            <div class="courses__item-thumb-seven shine__animate-link">
                                <a href="course-details.html"><img src="assets/img/courses/h7_course_thumb07.jpg" alt="img"></a>
                                <a href="courses.html" class="courses__item-tag-three">Environment</a>
                            </div>
                            <div class="courses__item-content-seven">
                                <ul class="courses__item-meta list-wrap">
                                    <li class="price">
                            ...
                            <div class="courses__item-bottom-three courses__item-bottom-five">
                                <ul class="list-wrap">
                                    <li><i class="flaticon-book"></i>Lessons 11</li>
                                    <li><i class="skillgro-group"></i>Students 500</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="courses__item-eight shine__animate-item">
                            <div class="courses__item-thumb-seven shine__animate-link">
                                <a href="course-details.html"><img src="assets/img/courses/h7_course_thumb08.jpg" alt="img"></a>
                                <a href="courses.html" class="courses__item-tag-three">Business</a>
                            </div>
                            <div class="courses__item-content-seven">
                                <ul class="courses__item-meta list-wrap">
                                    <li class="price">
                            ...
                            <div class="courses__item-bottom-three courses__item-bottom-five">
                                <ul class="list-wrap">
                                    <li><i class="flaticon-book"></i>Lessons 60</li>
                                    <li><i class="skillgro-group"></i>Students 600</li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <section class="cta__area-three">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-10">
                        <div class="cta__bg-three" data-background="assets/img/bg/h7_cta_bg.jpg">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 col-md-10">
                        <div class="choose__img-four">
                            ...
                            <img src="assets/img/others/h7_choose_shape01.svg" alt="shape" class="shape shape-one tg-motion-effects4">
                            <img src="assets/img/others/h7_choose_shape02.svg" alt="shape" class="shape shape-two alltuchtopdown">
                    ...
                    <div class="col-lg-6">
                        <div class="choose__content-four">
                            ...
                            <a href="login.html" class="btn arrow-btn btn-four">Start Free Trial <img src="assets/img/icons/right_arrow.svg" alt="" class="injectable"></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- categories-area -->
        <section class="categories-area-three fix section-pt-140 section-pb-110 categories__bg" data-background="assets/img/bg/categories_bg.jpg">
            <div class="container">
                <div class="row justify-content-center">
            ...
            <div class="categories__shape-wrap">
                <img src="assets/img/others/h7_categories_shape01.svg" alt="shape" class="rotateme">
                <img src="assets/img/others/h7_categories_shape02.svg" alt="shape" data-aos="fade-down-left" data-aos-delay="400">
                <img src="assets/img/others/h7_categories_shape03.svg" alt="shape" class="alltuchtopdown">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-xl-6 col-lg-6 col-md-8">
                        <div class="testimonial__img-three testimonial__img-four tg-svg">
                            ...
                            <span class="svg-icon" id="testimonial-svg-two" data-svg-icon="assets/img/others/h7_testimonial_img_shape.svg"></span>
                        </div>
                    </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="brand__item-two">
                                <img src="assets/img/brand/h7_brand01.png" alt="img">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand__item-two">
                                <img src="assets/img/brand/h7_brand02.png" alt="img">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand__item-two">
                                <img src="assets/img/brand/h7_brand03.png" alt="img">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand__item-two">
                                <img src="assets/img/brand/h7_brand04.png" alt="img">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand__item-two">
                                <img src="assets/img/brand/h7_brand05.png" alt="img">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand__item-two">
                                <img src="assets/img/brand/h7_brand06.png" alt="img">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand__item-two">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog__post-item-five shine__animate-item">
                            ...
                            <div class="blog__post-content-five">
                                <a href="blog.html" class="post-tag-four">Finance</a>
            ...
            <div class="container">
                <div class="newsletter__inner-wrap">
                    ...
                    <div class="newsletter__btn">
                        <a href="login.html" class="btn arrow-btn btn-two">Get Started Now <img src="assets/img/icons/right_arrow.svg" alt="" class="injectable"></a>
                    </div>
